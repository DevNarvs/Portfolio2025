...
export const MiniProject = [
  {
    name: 'Drums Kit',
    description:
      'Allows users to simulate playing a virtual drum set directly in their web browser. It features a responsive design that adapts to various screen sizes, providing an engaging experience for aspiring drummers and music enthusiasts.',
    tech: 'Developed using HTML, CSS, and JavaScript',
    img: '/Img/Drums.png',
    link: 'https://devnarvs.github.io/Drums/',
  },
  {
    name: 'Roll the Dice',
    description:
      'Provides users with a virtual die they can "roll" with a click of a button. The intuitive interface showcases a visual representation of a six-sided die, which dynamically changes to display a random number between 1 and 6 upon each roll. ',
    tech: 'Developed using HTML, CSS, and JavaScript',
    img: '/Img/Dice.png',
    link: 'https://devnarvs.github.io/Roll-the-Dice/',
  },
];

export const slides = [
  { src: '/Img/bg1.jpg', label: 'Slide 1' },
  { src: '/Img/Dice.png', label: 'Slide 2' },
  { src: '/Img/Drums.png', label: 'Slide 3' },
];
